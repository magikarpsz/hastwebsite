	...
	<div class="container">
		<section>
			<div class="page-header text-center" id="signup">
				...
				<form action="" class="form-inline centered" id="form" role="form">
					...
					<button type="submit" class="btn btn-danger" onclick="return show('submitform','form');">Sign up</button>
				</form>
		...
		<nav class="navbar navbar-default">
			<div class="container">
				...
				<div class="navbar-text pull-right">
					<a class="heroku-footer-icon-facebook" href="https://www.facebook.com/pages/HAST-Lab/1816766945216043?fref=ts" target="_blank"><i class="fa fa-facebook-square fa-2x"></a>
